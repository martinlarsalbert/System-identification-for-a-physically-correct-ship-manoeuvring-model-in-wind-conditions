...
\begin{table}[h]
    ...
    columns/LaTeX/.style={column type=l,string type,column name=~},
    columns/LaTeX1/.style={column type=l,string type, column name=~},
    columns/LaTeX2/.style={column type=l,string type, column name=~},
