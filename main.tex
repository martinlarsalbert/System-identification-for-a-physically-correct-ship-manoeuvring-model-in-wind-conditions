...
\begin{table}[h]
    ...
    columns/LaTeX/.style={column type=l,string type,column name=Par.},
    columns/LaTeX1/.style={column type=l,string type, column name=Par.},
    columns/LaTeX2/.style={column type=l,string type, column name=Par.},
    columns/LaTeX3/.style={column type=l,string type, column name=Par.},
    columns/Description/.style={column type=l,string type,column name=~},
    columns/Description1/.style={column type=l,string type, column name=~},
    columns/Description2/.style={column type=l,string type, column name=~},
