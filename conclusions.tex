...
The reference model has the same model structure as PI model, but with parameters identified with VCT regression; The so called mathematical model served as a reference for an uninformed model identified in the same way as PISM.
