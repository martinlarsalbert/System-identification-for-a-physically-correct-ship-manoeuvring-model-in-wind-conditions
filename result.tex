The parameters within the models (see \autoref{tab:parameters}) were identified with VCT regression for the reference model; And inverse dynamics regression for the mathematical model, and the PI model. 
\begin{table}[h]
    \centering
