...
For a nonstalling rudder, the lift coefficient $C_L$ is calculated according to \citet{whicker_free-stream_1958} with the additional parameter $\lambda_{gap}$ as shown in \autoref{eq:C_L_semiempirical}.
\begin{equation}
