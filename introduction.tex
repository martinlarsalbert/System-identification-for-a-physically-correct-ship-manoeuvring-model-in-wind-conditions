...
% * article structure?                      <--
In order to mitigate these difficulties a physics informed manoeuvring model is introduced in this paper, which features a new semi-empirical rudder model based on semi-empirical formulas from the literature;
