...
Many papers are based on the simulation data can effectively estimate the hydrodynamic coefficients since the exact ''psychical'' model is assumed known


The Kalman filter (KF) combined with maximum likelihood estimation was proposed in 1976 by \citet{} to develop a linear manoeuvring model that utilized manually recorded data in 1969 aboard the Atlantic Song freighter.
