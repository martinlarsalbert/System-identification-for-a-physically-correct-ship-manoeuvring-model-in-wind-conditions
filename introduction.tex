...
Together with the other drawbacks of CFD -- such as high computational costs -- data driven models have become an attractive alternative or complement to the other methods, with an increased number of publications in the past 10-15 years.
...
% * article structure?                      <--
Another way to mitigate these difficulties is used in this paper by introducing a physics informed manoeuvring model, which features a new semi-empirical rudder model based on semi-empirical formulas from the literature;
