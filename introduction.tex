...
Captive model tests is the classical approach to identify the parameters within these models. However, this approach is not practically possible for the full scale ships; Instead, virtual captive tests (VCT) -- which are essentially simulated captive tests with computational fluid dynamics (CFD) -- has emerged as an interesting option for the full scale ship predictions. 
