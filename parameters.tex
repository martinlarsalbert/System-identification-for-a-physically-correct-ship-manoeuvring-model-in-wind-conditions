\begin{table}[h]
    \centering
    \caption{Semi-empirical rudder parameters in model scale.}
    ...
    columns/Parameter1/.style={column type=c,string type, column name=Parameter},
    columns/Parameter2/.style={column type=c,string type, column name=Parameter},
