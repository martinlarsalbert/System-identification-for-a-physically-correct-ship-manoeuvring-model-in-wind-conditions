...
%The regression pipelines of the mathematical model (\autoref{tab:vct_pipeline_abkowitz}), and the Physics informed model (\autoref{tab:vct_pipeline_semiempirical}) are different. 
